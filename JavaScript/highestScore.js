...
let arrayOfMarks = student.map((student) => student.examScore.reduce((acc,curr) => curr.marks + acc , 0 ));

console.log(arrayOfMarks)

let Highest = arrayOfMarks.sort((a,b) => b-a);

console.log(`Highest Marks from array of student: ${Highest[0]}`)